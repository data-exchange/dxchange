...
def main():
    ...
    file_name = '/media/DISK_02/databank/templates/aps_1-ID/APS1ID_Cat4B_2/CAT4B_2_.tif'
    log_file = '/media/DISK_02/databank/templates/aps_1-ID/APS1ID_Cat4B_2/CAT4B_2_TomoStillScan.dat'
