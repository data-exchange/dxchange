...
def write_example(filename):
    ...
    sads8 = sampleGrp.create_dataset('temperature', data = 100.0, dtype='d')
    sads8.attrs['units'] = "celsius"

    # Create HDF5 subgroup 
    # /measurement/instrument
    instrumentGrp = measurementGrp.create_group("instrument")
    ids1 = instrumentGrp.create_dataset('name', data = "APS 2-BM")

    # Create HDF5 subgroup
    # /measurement/instrument/monochromator
    monochromatorGrp = instrumentGrp.create_group("monochromator")
    mds1 = monochromatorGrp.create_dataset('name', data = "DMM")
    mds2 = monochromatorGrp.create_dataset('energy', data = 10.00, dtype='d')
...
if __name__ == '__main__':
    ...
    write_example('/tmp/python/DataExchange-example4.h5')
#=======================================================================
#
#=======================================================================
